    ...
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm text-muted-foreground">Desenvolvido por Anderson Rosa ⚛</span>
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="transcription_prompt" className="h-20 leading-relaxed resize-none" placeholder="Inclua palavras-chave mencionadas no vídeo e separadas por vírgula (,)"/>
            </div>
